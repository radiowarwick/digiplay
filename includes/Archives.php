...
class Archives {
	...
	public static function get_by_id($id) { return DigiplayDB::select("* FROM archives WHERE id = :id", "Archive", false, $id); }
	public static function get_by_name($name) { return DigiplayDB::select("* FROM archives WHERE name = :name", "Archive", false, $name); }
