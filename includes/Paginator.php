...
//			$this->items_per_page = $this->default_n;
	...
	function display_items_per_page()
	{
		...
		return "<span>Items per page </span> <select name=\"items-per-page\" class=\"col-span-1\" onchange=\"window.location='$_SERVER[PHP_SELF]?q=$this->querystring&i=$this->index&p=1&n='+this[this.selectedIndex].value;return false\">$items</select>\n";
	}
	function display_jump_menu()
	{
		...
		return "<span>Page </span> <select class=\"col-span-1\" name=\"page-select\" onchange=\"window.location='$_SERVER[PHP_SELF]?q=$this->querystring&i=$this->index&p='+this[this.selectedIndex].value+'&n=$this->items_per_page';return false\">$option</select>\n";
	}
