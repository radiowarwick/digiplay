...
class Artists {
	...
	public static function get_by_id($id) { return DigiplayDB::select("* FROM artists WHERE id = ".$id, "Artist"); }
	public static function get_by_name($name) { return DigiplayDB::select("* FROM artists WHERE name = '".$name."'", "Artist"); }
