...
class Sustainer {
	...
	public static function get_total_length_formatted() {
                ...
                $time_str = (isset($time_arr["days"]))? $time_arr["days"]." days, " : "";
                $time_str .= (isset($time_arr["hours"]))? $time_arr["hours"]." hours, " : "";
                $time_str .= (isset($time_arr["minutes"]))? $time_arr["minutes"]." minutes, " : "";
                $time_str .= (isset($time_arr["seconds"]))? sprintf('%02d',$time_arr["seconds"])." seconds " : "00s ";
                return $time_str;
        }	
