...
class Jingles {
	...
	public static function get_total_jingles() { return DigiplayDB::select("COUNT(id) FROM audio WHERE type = ".AudioTypes::get("Jingle")->get_id()); }
	public static function get_total_length() { return DigiplayDB::select("SUM(length_smpl) FROM audio WHERE type = ".AudioTypes::get("Jingle")->get_id()) / 44100; }
