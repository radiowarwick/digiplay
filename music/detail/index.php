		...
		<fieldset>
			<div class=\"row\">
				...
				<div class=\"col-md-5 form\">
					...
					".(Session::is_group_user("Music Admin")? "<a href=\"".LINK_ABS."lib/preview/download.php?id=".$track->get_id()."\" class=\"btn btn-primary btn-block\">".Bootstrap::glyphicon("download-alt")." Download FLAC</a>" : "")."
				</div>
			</div>
		</fieldset>
	</form>
